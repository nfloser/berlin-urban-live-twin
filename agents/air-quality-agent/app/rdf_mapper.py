...
def lqi_to_graph(observation: AirQualityIndexObservation) -> Graph:
    ...
    graph.add((subject, PROV.wasDerivedFrom, BERLIN_LQI_SOURCE))
    predicates = {"PM10": CITY.lqiPM10, "PM2.5": CITY.lqiPM25, "NO2": CITY.lqiNO2, "O3": CITY.lqiO3, "CO": CITY.lqiCO, "SO2": CITY.lqiSO2}
